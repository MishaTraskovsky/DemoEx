...
/****** Object:  Database [DemoEx]    Script Date: 29.01.2021 15:05:13 ******/
CREATE DATABASE [DemoEx]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DemoEx', FILENAME = N'C:\Users\User\DemoEx.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DemoEx_log', FILENAME = N'C:\Users\User\DemoEx_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [DemoEx] SET QUERY_STORE = OFF
GO
